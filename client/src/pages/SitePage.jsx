  ...
  about: {
    ...
    body: (
      <>
        ...
        <p>Contact: <a href="mailto:ryan.mostert2006@gmail.com">ryan.mostert2006@gmail.com</a></p>
  ...
  privacy: {
    ...
    body: (
      <>
        ...
        <p>If you use the “Request a plan” form, we receive your name, email, location, package choice, and the message you type. That is sent to ryan.mostert2006@gmail.com so we can reply. We do not sell that information.</p>
        ...
        <p>To ask us to delete a message you sent, email ryan.mostert2006@gmail.com.</p>
      </>
    ),
  },
  terms: {
    ...
    body: (
      <>
        ...
        <p>Questions: ryan.mostert2006@gmail.com</p>
      </>
    ),
  },
};
